...
<div class="totalcounts">총<b>0</b>개</div>
	...
	<a href="${pageContext.request.contextPath}/resources/Files/faqFiles/온라인클래스 FAQ.hwp" class="key_color" download><img src="${pageContext.request.contextPath }/resources/images/faq/downloadImage.png" class="downima"><b>온라인클래스 자주묻는질문(FAQ) 다운로드</b></a>
	</div>
