...
<div class="login">
	...
	<h5 style="color:blue">*Chrome 사용시 로그인이 안되거나 로딩이 길어질 경우 [Ctrl]+[Shift]+[R]을 클릭해주세요.</h5>
		<form action="dologin" method="post">
			<input id="id" name="user_id" class="form-control" type="text" placeholder="아이디" style="width:300px;height:40px;font-size:15px;border-radius:0.2em;position:relative;top:20px;"><br>
			<input id="password" name="user_pw" class="form-control" type="password" placeholder="비밀번호" style="width:300px;height:40px;font-size:15px;border-radius:0.2em;position:relative;top:5px;">
