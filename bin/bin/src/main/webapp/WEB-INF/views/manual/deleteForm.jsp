...
<div style="padding: 40px 14% 20px 14%;">
	...
	<div>
		...
		<tr style="background-color: ; border-top: 2px solid #2580EB;">
			<th style="padding : 15px 0; width: 15%;">선택</th>
			<th>메뉴얼명</th>
		...
		<tr>
			<td align="center" style="padding: 15px 0;"><input type="checkbox" name="nums" value="${dto.num }"></td>
			<td>${dto.subject}</td>
			<td align="center" style="font-size: 20px; color:black;"><i class="fas fa-play"></i></td>
	...
	<div>
		...
		<tr>
			...
			<td>${dto.subject}</td>
			<td align="center"><i class="fas fa-file-download" style="font-size: 20px; color:black;"></i></td>
			<td align="center">${dto.reg_date}</td>
		</tr>
		</c:forEach>
		</table>
