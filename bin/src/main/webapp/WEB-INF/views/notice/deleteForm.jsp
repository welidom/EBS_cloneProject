...
<div style="padding: 40px 14% 20px 14%;">
	<form action="deleteNotice" name= "deleteNums" method="post">
	<div style="font-weight: bold;">
		...
		<a href="notice" style="float:right; color:white; background-color: #2580EB; border: 1px solid; padding:10px; border-radius: 40px; font-weight: bold;">공지사항 취소  〉</a>
		</span>
	</div>
	...
	<c:set var="color" value="black"/>
		...
		<c:choose>
			<c:when test="${dto.attach ne null}"><td align="center"><span style="font-size: 20px; color:black;"><i class="fas fa-paperclip"></i></span></td></c:when>
